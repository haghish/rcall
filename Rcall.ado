...
Enter R _console mode_ within Stata. {help Rcall##running_R:Read more...}
...
program define Rcall , rclass
	...
	capture Rpath
	capture quietly prog drop Rcall_synchronize_mode
	capture quietly Rcall_synchronize_mode
